...
public class Snack {
	...
	//다만, 컴파일러의 눈에만 보일뿐 우리가 보는 코드에는 생략되어 있다.
...
//	}
	...
	//생성자를 통해 객체를 초기화 한다는 것은 필드와 메서드를 호출하는 등 
	//객체를 사용하기 위해 메모리에 올림과 동시에, 더 나아가 객체 멤버에 접근이 가능하므로
	//일반적인 메서드처럼 객체 멤버의 데이터를 초기화 할 수 있다.
	//메서드를 통해 매개변수에 값을 전달할 수 있었던 것처럼
