...
public class Ex05_lamda {
	...
	public static void main(String[] args) {
		//R apply(T t)
		Function<String, Integer> f = s -> Integer.parseInt(s,16); //16진수의 변환
		Function<Integer, String> g = i -> Integer.toBinaryString(i); //2진수의 변환
		Function<String,String> h = f.andThen(g);
		System.out.println(h.apply("FF")); // FF -> 255 -> 2진수 11111111
